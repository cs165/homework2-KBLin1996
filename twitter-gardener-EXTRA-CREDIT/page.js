...
function gardening(e,tweet)
{
	...
	for(let i=0,cl=children.length;i<cl;i++)
	{
		if(children[i].className == 'content')
		{
			...
			for(let j=0,ccl=x.length;j<ccl;j++)
			{
